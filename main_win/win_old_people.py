...
# Form implementation generated from reading ui file 'win_old_people.ui'
#
...
"")
        ...
        self.fallDetectBox = QtWidgets.QCheckBox(self.groupBox_8)
        ...
        self.fallDetectBox.setPalette(palette)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.fallDetectBox.setFont(font)
        self.fallDetectBox.setObjectName("fallDetectBox")
        self.verticalLayout_8.addWidget(self.fallDetectBox, 0, QtCore.Qt.AlignLeft)
        self.emotionRecBox = QtWidgets.QCheckBox(self.groupBox_8)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(238, 238, 236))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.emotionRecBox.setPalette(palette)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.emotionRecBox.setFont(font)
        self.emotionRecBox.setObjectName("emotionRecBox")
        self.verticalLayout_8.addWidget(self.emotionRecBox, 0, QtCore.Qt.AlignLeft)
        self.standBOX = QtWidgets.QCheckBox(self.groupBox_8)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(238, 238, 236))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.standBOX.setPalette(palette)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.standBOX.setFont(font)
        self.standBOX.setObjectName("standBOX")
        self.verticalLayout_8.addWidget(self.standBOX, 0, QtCore.Qt.AlignLeft)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "智慧养老"))
        self.label_4.setText(_translate("mainWindow", "智慧养老"))
        ...
        self.fallDetectBox.setText(_translate("mainWindow", "跌到检测"))
        self.emotionRecBox.setText(_translate("mainWindow", "表情识别"))
        self.standBOX.setText(_translate("mainWindow", "睡眠监测"))
