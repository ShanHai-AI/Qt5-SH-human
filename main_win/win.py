...
"")
        ...
        self.sktBox = QtWidgets.QCheckBox(self.groupBox_8)
        ...
        self.sktBox.setPalette(palette)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.sktBox.setFont(font)
        self.sktBox.setObjectName("sktBox")
        self.verticalLayout_8.addWidget(self.sktBox)
        self.gazecheckBox = QtWidgets.QCheckBox(self.groupBox_8)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(238, 238, 236))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.WindowText, brush)
        self.gazecheckBox.setPalette(palette)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.gazecheckBox.setFont(font)
        self.gazecheckBox.setObjectName("gazecheckBox")
        self.verticalLayout_8.addWidget(self.gazecheckBox)
        ...
        self.verticalLayout_8.addWidget(self.standBOX)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "智慧课堂"))
        self.label_4.setText(_translate("mainWindow", "智慧课堂"))
        ...
        self.sktBox.setText(_translate("mainWindow", "骨架识别"))
        self.gazecheckBox.setText(_translate("mainWindow", "Gaze估计"))
        self.standBOX.setText(_translate("mainWindow", "课堂动作（举手，起立）"))
