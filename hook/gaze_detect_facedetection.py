# 基于face-detection 人脸检测模型的gaze hook
...
def init_model(arch='ResNet50',snapshot_path=str(ROOT)+"/lazernet/models/L2CSNet/Gaze360/L2CSNet_gaze360.pkl"):
    cudnn.enabled = True
