...
def init_model():
    ...
    pose_config=ROOT/'mmpose/configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/shufflenetv2_coco_256x192.py'
    pose_checkpoint=ROOT/'mmpose/weights/shufflenetv2_coco_256x192-0aba71c7_20200921.pth'
    device='cuda:0'
    pose_model = init_pose_model(
        pose_config, 
        pose_checkpoint, 
