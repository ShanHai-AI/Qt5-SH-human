...
## Note
reid_export.py 用于跟踪模型onnx、tensorrt导出。导出命令：
```
python reid_export.py --dynamic
```


## 文件说明
mmpose：用于骨架检测，安装方式参考github：https://github.com/open-mmlab/mmpose
track.py: 原目标检测+多目标跟踪文件
track+pose.py:
